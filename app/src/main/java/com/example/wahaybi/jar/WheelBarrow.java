...
public class WheelBarrow extends AppCompatActivity  {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolImageView.setImageResource(R.drawable.wheelbarrow);

        TextView toolName = findViewById(R.id.tool_name);
        toolName.setText("Tool name: Wheel Barrow");

        TextView toolLocation = findViewById(R.id.tool_location);
        toolLocation.setText("Location: Muscat");
        ...
        toolOwnerName.setText("Owner: Kahled");

        TextView phoneNumber = findViewById(R.id.owner_phone_number);
        phoneNumber.setText("Phone Number: 998434543");
    }
}
